...
def dashboard():
    if 'username_' in session:
                ...
                if user_find is not None:
                    for i in user_find:
                        if i == uid:
                            ...
                            msg = "Welcome", emails
                            return render_template('dashboard.html', hide_button_script=hide_button, codes=msg,
                                                   hide=hide_label, hide_en=hide_entry, sub=hide_sub)
                    else:
                        pass
                else:
                    pass
        ...
        if keys is not None:
            ...
            key_val = key_1['key']
            val = key_val
            hide_label = "<script>var gen_button = document.getElementById(' ').style.display = 'none';</script>"
            hide_entry = "<script>var gen_button = document.getElementById('gen__button').style.display = 'none';</script>"
            hide_sub = "<script>var gen_button = document.getElementById('btn').style.display = 'none';</script>"
        ...
        #         return render_template('home.html', hide_button_script=hide_button , codes = msg, hide = hide_label , hide_en = hide_entry, sub = hide_sub)
            ...
            try:
                if request.method == 'POST':
                    ...
                    hide_entry = "<script>var gen_button = document.getElementById('gen__button').style.display = 'none';</script>"
                    hide_sub = "<script>var gen_button = document.getElementById('btn').style.display = 'none';</script>"
                    msg = "Your key is ", emails
                    return render_template('dashboard.html', hide_button_script=hide_button, codes=msg, hide=hide_label,
                                           hide_en=hide_entry, sub=hide_sub)
